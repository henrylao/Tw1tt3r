...
<img src="https://github.com/henrylao/Tw1tt3r/blob/dev/docs/portrait-tweet-compose-02-21-21.gif" width=250><br>


## Notes

* Usage of startActivityForResult for saving data into a passed variable when returning from a child activity back to the parent activity
    1. Parcelable: preferred b/c more performant but more code
    2. Serializable 

# Project 2 (Unit 3) - *Tw1tt3r*
